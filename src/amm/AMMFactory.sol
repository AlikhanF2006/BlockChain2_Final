...
contract AMMFactory {
    ...
    function createPair(address tokenA, address tokenB) external returns (address pair) {
        ...
        // Slither may flag external calls below before state updates. The calls deploy trusted protocol contracts
        // (AMMPool, ERC1967Proxy, LPToken) and initialize the freshly deployed pair; no user-controlled callback is made.
