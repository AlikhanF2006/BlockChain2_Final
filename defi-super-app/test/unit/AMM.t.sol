...
contract AMMTest is Test {
    ...
    function test_GetAmountOut_MatchesAssembly() public {
        for (uint256 i = 1; i < 100; i++) {
            ...
            assertEq(pool.getAmountOut(amountIn, 100 ether, 200 ether), pool.getAmountOutAssembly(amountIn, 100 ether, 200 ether));
        }
    }
    ...
    function _deployPool(address token0, address token1) internal returns (AMMPool deployedPool, LPToken deployedLpToken) {
